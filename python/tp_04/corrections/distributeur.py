...
myFolderpath = pathlib.Path(
    __file__
).parent.resolve()  # on récupère le chemin du programme
...
if os.path.exists("listpiece.csv"):
    ...
    dicPieces = {50: 10, 20: 10, 10: 10, 5: 10}
...
while True:
    ...
    for boisson in dicBoissons:
        print(
            dicBoissons[boisson]["numero"],
            boisson,
            ":",
            dicBoissons[boisson]["prix"],
            "€",
        )
    print(0, "Annuler")
    ...
    if choix > "0":
        ...
        for boisson in dicVentes:
            print(
                ...
                ":",
                dicVentes[boisson],
                dicBoissons[boisson]["prix"] * dicVentes[boisson],
                "€",
            )
